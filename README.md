...
[![build-ublue](https://github.com/wachkyri/bazzite-dx/actions/workflows/build.yml/badge.svg)](https://github.com/wachkyri/bazzite-dx/actions/workflows/build.yml)
...
> **Note**
> Everywhere in this repository, make sure to replace `wachkyri/bazzite-dx` with the details of your own repository. Unless you used one of the automatic repository setup tools in which case the previous repo identifier should already be your repo's details.
...
- First rebase to the unsigned image, to get the proper signing keys and policies installed:
  ```
  rpm-ostree rebase ostree-unverified-registry:ghcr.io/wachkyri/bazzite-dx:latest
  ```
...
- Then rebase to the signed image, like so:
  ```
  rpm-ostree rebase ostree-image-signed:docker://ghcr.io/wachkyri/bazzite-dx:latest
  ```
...
```
rpm-ostree rebase ostree-image-signed:docker://ghcr.io/wachkyri/bazzite-dx:20230403
```
